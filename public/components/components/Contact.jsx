...
const Contact = () => {
  ...
  return (
    ...
    >
        ...
        >
          <label className="flex flex-col">
            ...
            <input
              ...
              className="bg-tertiary py-4 px-6 placeholder:text-gray-600 placeholder:text-xs text-white rounded-lg outline-none border-none font-medium"
            />
          </label>
          <label className="flex flex-col">
      ...
      >
        <PhoneCanvas model="https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/iphone-x/model.gltf" />
      </motion.div>
    </div>
  );
};
